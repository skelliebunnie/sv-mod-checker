...
-->
	<?php
		...
		$folderPath = "C:\Program Files (x86)\Steam\steamapps\common\Stardew Valley\Mods";
		if($_POST && array_key_exists('rootDirectory', $_POST) && $_POST['rootDirectory'] !== "") {
	...
	<form action="modchecker.php" method="post">
		<label for="rootDirectory">Directory: </label>
		<input type="text" id="rootDirectory" name="rootDirectory" value="<?php echo $folderPath; ?>">
		<button type="submit">Get Mods</button>
	</form>

	<div class="alerts">
		<div id="error" class="msg-box hidden">
			<h2>REQUIRED MODS MISSING!</h2>
			<p class="list"></p>
		</div>

		<div id="warning" class="msg-box hidden">
			<h2>MODS SKIPPED!</h2>
			<p class="list"></p>
		</div>

		<div id="alert" class="msg-box hidden">
